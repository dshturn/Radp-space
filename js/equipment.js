          ...
          <div class="body-inner"><div class="body-content">
            <div class="doc-group collapsed">
              ...
              <div class="doc-group-body"><div class="doc-group-inner">
                ${scDocsHtml}
                <button class="upload-btn upload-btn-sm" onclick="openAddDoc(${parseInt(sc.id)}, this.dataset.name)" data-name="${esc(sc.name)}">+ Add Document</button>
              </div></div>
            </div>
          </div></div>
        </div>
      ...
      <div class="sub-card-body">
        <div class="body-inner"><div class="body-content">
          <div class="doc-group collapsed">
            ...
            <div class="doc-group-body"><div class="doc-group-inner">
              ${subDocsHtml}
              <button class="upload-btn upload-btn-sm" onclick="openAddDoc(${parseInt(sub.id)}, this.dataset.name)" data-name="${esc(sub.name)}">+ Add Document</button>
            </div></div>
          </div>
          <div class="mt-sm">
            ${subChildrenHtml}
